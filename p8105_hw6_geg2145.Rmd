...
**From these, we will use `delwt`, `gaweeks` and ` wtgain`, to avoid using variables about the baby's features to predict its birthweight.**

```{r p3_my_model}
my_fit = lm(bwt ~ delwt + gaweeks + wtgain, data = df_birthweight)
